 ...
 */
@ObjectCreate(pattern = "accessoryList/accessory")
public class AccessoryCO {
    @BeanPropertySetter(pattern = "accessoryList/accessory/strength")
    private int strength;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple1")
    private int purple1;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple2")
    private int purple2;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple3")
    private int purple3;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple4")
    private int purple4;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple5")
    private int purple5;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple6")
    private int purple6;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple7")
    private int purple7;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple8")
    private int purple8;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple9")
    private int purple9;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple10")
    private int purple10;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple11")
    private int purple11;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple12")
    private int purple12;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple13")
    private int purple13;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple14")
    private int purple14;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple15")
    private int purple15;
    @BeanPropertySetter(pattern = "accessoryList/accessory/purple16")
