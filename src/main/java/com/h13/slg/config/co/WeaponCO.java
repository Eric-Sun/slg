 ...
 */
@ObjectCreate(pattern = "weaponList/weapon")
public class WeaponCO {
    @BeanPropertySetter(pattern = "weaponList/weapon/strength")
    private int strength;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple1")
    private int purple1;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple2")
    private int purple2;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple3")
    private int purple3;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple4")
    private int purple4;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple5")
    private int purple5;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple6")
    private int purple6;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple7")
    private int purple7;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple8")
    private int purple8;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple9")
    private int purple9;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple10")
    private int purple10;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple11")
    private int purple11;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple12")
    private int purple12;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple13")
    private int purple13;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple14")
    private int purple14;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple15")
    private int purple15;
    @BeanPropertySetter(pattern = "weaponList/weapon/purple16")
